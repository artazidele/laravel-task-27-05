    ...
    <div class="container">
        ...
        <form method="POST" action="/createitem">
            ...
            <div class="form-group">
                ...
                <input class="form-control mb-2" name="count" type="number" />
            </div>
            <div class="form-group">
                <label class="form-label">Cena: </label>
                <input class="form-control mb-4" name="price" type="number" step=".01" />
            </div>
            <input class="btn btn-primary" type="submit" value="Pievienot jaunu preci" />
        </form>
    </div>
